...
const BONUS = {
  ...
  shop: { pipeTags: ['in', 'out'], fallDeath: false, shop: true, map: [
    '%%%%||%%%%%%%%%%%%%%%%%%', '%...||.................%', '%...dd.................%', '%......................%', '%......................%', '%......................%', '%......................%', '%......................%',
    '%......................%', '%......................%', '%..........,...........%', '%.......L.........uu...%', '%.................||...%', '%######################%', '%%%%%%%%%%%%%%%%%%%%%%%%'], ents: [{ t: 'npc', x: 6, y: 12, who: 'luigi', lines: ['Willkommen im Späti. Hafermilch 30, Mate 40, Sinans Ball 60, BRB 100.', 'Drück ↓ um den Shop zu öffnen.'] }, { t: 'sign', x: 12, y: 10, text: 'SPÄTI24 - seit 3 Uhr nachts. ↓ = Shop' }] },
...
const SCENES = {
  prologue: [
    { bg: 'room', who: 'luigi', text: 'Neue Wohnung! Kartons ausgepackt: 3 von 47. imp, du wolltest "koordinieren"?' },
    { who: 'imp', text: 'Ich koordiniere vom Sofa aus. Stream startet um 20 Uhr. Es ist... 20:17. Pünktlich wie immer.' },
    { who: 'imp', text: '*klick* "Stream starten"... "Keine Internetverbindung." ...Luigi?' },
    { who: 'luigi', text: 'Der Techniker von NIXNET kommt zwischen 8 und 18 Uhr.' },
    { who: 'imp', text: 'Luigi. Es ist 20 Uhr.' }, { who: 'luigi', text: 'Von welchem Tag stand da nicht.' },
    ...
    { who: 'luigi', text: 'imp... ohne Stream: Werbepartner weg, Abos laufen aus, Bits null. In zehn Tagen ist der Kanal OFFLINE.' },
    { who: 'imp', text: 'Und dieses gelbe Kabel, das aus der Wand kommt und um die Ecke verschwindet...?' },
    { who: 'luigi', text: 'NIXNET hat unsere Glasfaser verlegt. Nur nicht zu uns. Irgendwohin.' },
    { who: 'imp', text: 'Dann hol ich mir Sponsoren, Abos und das Internet eben zurück. Persönlich. Zu Fuß.' },
    { who: 'luigi', text: 'ZU FUSS?!' }, { who: 'imp', text: 'Nö. Mit Röhren.' },
    { who: 'marx', text: 'Proletarier aller Kieze... folgt dem Kabel.' }, { who: 'imp', text: 'Die Büste redet seit dem Umzug. Ich frag lieber nicht.' },
  ],
  l1_intro: [{ who: 'luigi', text: 'Das Kabel führt ins Treppenhaus. Kartons kann man tragen und werfen. Nicht auf mich.' }, { who: 'imp', text: 'Ich werfe nur auf Sponsoren-Verträge. Und Wände.' }, { who: 'luigi', text: 'Der Nachbar grillt schon wieder. Halt Abstand zu Bratwürsten. Und sammle Bits, Abos und die HOLF-Pokale!' }],
  l1_outro: [{ who: 'sponsor', text: 'HAFI - Hafermilch, die dich versteht! Herr imp, wir wollen Sie sponsern! Nur hier unterschreiben, 14 Seiten.' }, { who: 'imp', text: 'Vierzehn Seiten. Luigi?' }, { who: 'luigi', text: '*unterschreibt* Erledigt. Kleingedrucktes: Du musst jeden Stream mit "Hafi!" eröffnen.' }, { who: 'imp', text: 'Hafi.' }, { who: 'sponsor', text: 'Und ich bin von GLATTMANN Rasierklingen. Wir hätten auch Interesse...' }, { who: 'imp', text: '...an meinem Bart? Nein. Das Kabel geht hier raus in den Kiez. Weiter.' }],
  l2_intro: [{ who: 'imp', text: 'Plan B: fremdes WLAN. "FRITZ!Box-nein", "Kein Internet hier", "Passwort ist Passwort". Vielversprechend.' }, { who: 'luigi', text: 'Manche Ecken sind komplett OFFLINE. Such den Hotspot-Router und schalte ihn ein (↑). Aber Achtung: das Signal reicht nicht weit.' }, { who: 'luigi', text: 'Und Sinan steht irgendwo rum und posiert. Spring auf seinen Bizeps, das katapultiert dich hoch.' }],
  ...
  l2_outro: [{ who: 'sponsor', text: 'Späti24 - Mate & Chips, seit 3 Uhr nachts. Vertrag?' }, { who: 'luigi', text: '*unterschreibt* Wir kriegen lebenslang Mate. Du musst dafür ein Späti-Shirt tragen.' }, { who: 'imp', text: 'Ich trage gar nichts, was mir jemand sagt. Außer Luigi. Wo geht das Kabel hin?' }, { who: 'luigi', text: 'Ins... Bürgeramt für Anschlussangelegenheiten.' }, { who: 'imp', text: 'Nein. Nein. Nein. NEIN.' }],
  l3_intro: [{ who: 'luigi', text: 'Du brauchst die Anschlussgenehmigung, Formular G-4/Fiber. Formulare kleben an dir fest, dann Sprung-Taste hämmern!' }, { who: 'imp', text: 'Papierkram. Mein Endgegner. Und wir sind erst in Level 3.' }, { who: 'marx', text: 'Hier hält man mich für dich und dich für mich. Nutze das. Mit dem Marx-Ausweis ignorieren dich die Sachbearbeiter.' }],
  l3_outro: [{ who: 'sponsor', text: 'FormFrei - die App, die deine Formulare ausfüllt. Irgendwann. Genehmigung erteilt!' }, { who: 'imp', text: 'ENDLICH. Für welche Adresse?' }, { who: 'sponsor', text: 'Schanzenhof, Altschauerberg.' }, { who: 'imp', text: '...das ist nicht meine Adresse.' }, { who: 'luigi', text: 'Aber da liegt jetzt das Kabel. In einer Scheune. Bei einem gewissen... Drachenlord.' }, { who: 'imp', text: 'Meddl.' }],
  l4_intro: [{ who: 'luigi', text: 'Fränkische Provinz. Grillfest. Heuballen rollen den Hang runter, und die Kessel schießen Würste.' }, { who: 'imp', text: 'Ein ganzes Dorf grillt Fleisch. Und ich hab nur Tofu-Argumente.' }, { who: 'luigi', text: 'Der Vegan-Award (grüner HOLF) macht alle Fleischgegner zu Tofu. Nur so als Tipp.' }],
  l4_boss: [{ who: 'dl', text: 'MEDDL LOIDE! Des is mei Hof, mei Kabel und mei Grillfleisch!' }, { who: 'imp', text: 'Zwei von drei Dingen sind mir egal.' }, { who: 'dl', text: 'Ich roll dich platt wie an Fels, du Haider!' }, { who: 'luigi', text: 'Er rollt sich zur Kugel! Spring drüber. Wenn er gegen die Wand knallt, ist er benommen: STAMPFEN!' }],
  l4_outro: [{ who: 'sponsor', text: 'Seitan-Schmiede - Fleischersatz aus Franken. Etzala vegan! Vertrag?' }, { who: 'luigi', text: '*unterschreibt* Wir bekommen 300 kg Seitan. Pro Monat.' }, { who: 'imp', text: 'Luigi, ich hab eine Zweizimmerwohnung.' }, { who: 'dl', text: 'Etzala... des Kabel geht in den Gully. Da unten is a Röhrensystem. Viel Spaß, Haider.' }],
  l5_intro: [{ who: 'luigi', text: 'Die Kanalisation. Das Kabel verzweigt sich in ein Knäuel aus Röhren. Blaue Röhren führen weiter, aber nur die richtige Reihenfolge bringt dich zum Ausgang.' }, { who: 'marx', text: 'Die Wahrheit will erarbeitet werden. Frag mich (H). Ich rede in Rätseln. Das ist mein Ding.' }, { who: 'imp', text: 'Großartig. Ein Orakel mit Bart. Also ich. Aber älter.' }],
  l5_outro: [{ who: 'sponsor', text: 'RohrFrei - Abflussreiniger für jedes Röhrensystem. Sie sind unser Mann!' }, { who: 'luigi', text: '*unterschreibt* Wir müssen einmal die Woche live einen Abfluss reinigen.' }, { who: 'imp', text: 'Das ist mehr Struktur als mein ganzes Leben. Was steht auf dem Schild da?' }, { who: 'luigi', text: '"Honigwald. Bitte nicht füttern."' }],
  l6_intro: [{ who: 'luigi', text: 'Der Honigwald. Honigboden ist klebrig, an Honigwänden kannst du hochklettern (an die Wand drücken + Sprung). Soletti-Brücken brechen!' }, { who: 'imp', text: 'Wer wohnt hier?' }, { who: 'luigi', text: 'Ein Bär im rosa Overall. Er hat unser Kabel als Wäscheleine benutzt.' }],
  l6_boss: [{ who: 'baba', text: 'Wer stört meine Soletti-Pause?! BABA!' }, { who: 'imp', text: 'Ich will nur mein Kabel. Das da. Mit deiner Unterhose drauf.' }, { who: 'baba', text: 'Das ist ein OVERALL. Und der bleibt!' }, { who: 'luigi', text: 'Seine Soletti bleiben im Boden stecken: nutz sie als Plattformen oder wirf sie zurück! Wenn er schläft: auf den Bauch springen!' }],
  l6_outro: [{ who: 'sponsor', text: 'Agavo - der Honig ohne Bienenstress. Endlich ein veganer Streamer!' }, { who: 'luigi', text: '*unterschreibt* Kein Kleingedrucktes. Ich bin misstrauisch.' }, { who: 'baba', text: 'Das Kabel? Geht nach Wien. Baba!' }, { who: 'imp', text: 'Nein.' }, { who: 'luigi', text: 'Doch.' }, { who: 'imp', text: 'Warum. Immer. Wien.' }],
  l7_intro: [{ who: 'imp', text: 'Wien. Von hier kommen immer so viele komische Leute. Und jetzt bin ich hier. Das sagt alles.' }, { who: 'luigi', text: 'Riesenrad-Gondeln sind Plattformen. Fiaker rasen durchs Bild. Und die Warteschleifen-Geister kommen nur näher, wenn du wegschaust!' }, { who: 'imp', text: 'Also wie mein Chat.' }],
  l7_boss: [{ who: 'ober', text: 'Ham\'S reserviert?' }, { who: 'imp', text: 'Ich will nur durch.' }, { who: 'ober', text: 'Dann ham\'S nicht reserviert.' }, { who: 'luigi', text: 'Der ist unbesiegbar. Aber käuflich: sammle 5 Trinkgeld-Münzen und leg sie auf den Tisch (↓+Shift). Oder zahl 100 Bits (↓ am Tisch).' }],
  l7_outro: [{ who: 'sponsor', text: 'Melange-to-go - Wiener Kaffee ohne den Grant. Passt scho?' }, { who: 'luigi', text: '*unterschreibt* Passt scho.' }, { who: 'imp', text: 'Am Riesenrad hängt ein Schild: "Kabel geht weiter → YouTube-Tower. Alternativeinnahmen?"' }, { who: 'luigi', text: 'Videos statt Live! Der Algorithmus wird uns lieben!' }, { who: 'imp', text: 'Der Algorithmus liebt niemanden, Luigi.' }],
  l8_intro: [{ who: 'luigi', text: 'Der YouTube-Tower. Es geht nach oben! Clickbait-Plattformen verschwinden, Cookie-Banner: spring auf "nur notwendige", NICHT auf "alle akzeptieren".' }, { who: 'luigi', text: 'Hier oben geht\'s ums Geld: Zollschranken kassieren 25% deiner Bits. Es gibt immer einen Umweg. Und ein Privatjet wirft Aktenkoffer ab. Firewall-Blöcke halten sie auf.' }, { who: 'imp', text: 'Ein Jet. Klar. Ganz normal.' }],
  l8_boss: [{ who: 'algo', text: 'NUTZER ERKANNT: imp. WATCHTIME: NIEDRIG. EMPFEHLUNG: MEHR SCHREIEN IM THUMBNAIL.' }, { who: 'imp', text: 'Ich schreie nie. Ich rede nur laut und lange.' }, { who: 'luigi', text: 'Wenn sein Abonnieren-Button rot leuchtet: DRAUFSPRINGEN!' }],
  l8_outro: [{ who: 'sponsor', text: 'ThumbNail Pro - Clickbait für Einsteiger! (GONE WRONG) (NICHT KLICKEN)' }, { who: 'luigi', text: '*unterschreibt* Dein Gesicht muss ab jetzt auf jedem Thumbnail überrascht sein.' }, { who: 'imp', text: 'Ich BIN überrascht. Dauerhaft. Seit Level 1.' }, { who: 'algo', text: 'FEHLER 404... NIXNET hat das Kabel nicht falsch verlegt. NIXNET hat es ABSICHTLICH in die eigene Zentrale gelegt. Als PREMIUM-UPGRADE.' }, { who: 'imp', text: 'Also doch Kapitalismus.' }, { who: 'marx', text: 'Sag ich doch seit 1867.' }],
  l9_intro: [{ who: 'luigi', text: 'Die NIXNET-Zentrale. Du brauchst Tickets für die Schleusen, und die laufen ab! Captcha-Blöcke: nur die mit Fahrrädern anstoßen.' }, { who: 'luigi', text: 'Und in der Lobby läuft Mario Barth rum. Wenn er dich erwischt: Smalltalk-Falle. Tasten hämmern zum Losreißen!' }, { who: 'imp', text: 'Kennste? Nein. Und das bleibt auch so.' }],
  l9_boss: [{ who: 'volker', text: 'Herr imp! Vertriebler Volker! Nur heute: 1000 Mbit für 99 Euro! 24 Monate! Plus Router-Miete!' }, { who: 'imp', text: 'Ich will das Internet, das ich schon bezahle.' }, { who: 'volker', text: 'Das ist leider der Grundtarif. Der hat keine Verbindung inklusive.' }, { who: 'luigi', text: 'Nach jeder Verkaufsphrase verbeugt er sich. Das ist dein Moment!' }],
  l9_outro: [{ who: 'sponsor', text: 'VPN-Vorhang - damit nicht mal NIXNET sieht, dass du kein Internet hast.' }, { who: 'luigi', text: '*unterschreibt* Wir müssen in jedem Video "Mit dem Code IMP 3 Monate gratis" sagen.' }, { who: 'imp', text: 'Das sag ich eh im Schlaf. Da: ein Schacht. "Glasfaser-Backbone. Zutritt nur für Premium-Kunden."' }, { who: 'imp', text: 'Ich bin Premium. Ich bin seit zehn Tagen ohne Internet, das ist Premium-Leiden.' }],
  l10_intro: [{ who: 'luigi', text: 'Die Glasfaser-Unterwelt. Alles, was du gelernt hast, kommt hier zusammen. Sinan, Baba, Marx und ich funken dich an.' }, { who: 'sinan', text: 'Bruder, ich steh vor der letzten Tür und pos. Spring drauf.' }, { who: 'baba', text: 'Ich werf Agavendicksaft, wenn\'s eng wird! Baba!' }, { who: 'marx', text: 'Am Ende wartet die Warteschleife selbst. Sie wurde zur Maschine. Drücke, was sie sagt. Und dann drück sie weg.' }, { who: 'imp', text: 'Zehn Level. Kein Netz. Kein Stream. Aber einen Plan. Halb.' }],
  l10_boss: [{ who: 'nixi', text: 'WILLKOMMEN BEI NIXNET. IHR ANRUF IST UNS WICHTIG. BITTE BLEIBEN SIE DRAN.' }, { who: 'imp', text: 'Ich bin seit zehn Leveln dran.' }, { who: 'nixi', text: 'IHRE VORAUSSICHTLICHE WARTEZEIT BETRÄGT: FÜR IMMER.' }, { who: 'luigi', text: 'Spring auf den Hörer, wenn er runterkommt! Dann drück die richtigen Nummern! Und am Ende: DER STECKER!' }],
  ending: [
    { bg: 'room', who: 'imp', text: '*klick* Die LED... ist GRÜN.' }, { who: 'luigi', text: 'INTERNET! Wir haben INTERNET! Nach zehn Leveln, acht Bossen und einem Bären!' },
    { who: 'sponsor', text: 'Glasfaser-Gigi - endlich Internet. Selbstbau-Set. Sie haben es ja quasi selbst verlegt!' }, { who: 'luigi', text: '*unterschreibt* Der letzte Vertrag. Zehn Werbepartner. Der Kanal ist gerettet.' },
    { who: 'imp', text: 'Schnell nach Hause. Stream startet um 20 Uhr. Es ist... egal. *klick* "Stream starten".' },
    { chat: ['impimpimp', 'impimpimp', 'ER LEBT', 'endlich wieder Dauersatiresendung', 'impimpimp', 'wo ist luigi', 'LUIGI HAT EINEN RASIERER-DEAL LUL', 'impimpimp'] },
    { who: 'sponsor', text: 'GLATTMANN Rasierklingen hier. Wir haben jetzt übrigens Luigi unter Vertrag.' }, { who: 'luigi', text: '*glatt rasiert* Es war das Kleingedruckte.' },
