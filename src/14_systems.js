/* =====================================================================
   ...
   ===================================================================== */
const CHAT_NAMES = [
  ['hafermilchHans', '#ff7f50'], ['wiener_oida', '#9acd32'], ['nixnet_support_bot', '#ff4500'], ['luigi_fan_01', '#7bd23a'], ['marxistin93', '#e03a3a'], ['sinan_mit_ss', '#ff69b4'],
...
const CHAT_REACT = {
  ...
  zoll: ['zoll nimmt 25%', 'tariffs LUL', 'der zoll hat gewonnen'], gift: ['GIFTED SUB POG', 'danke für den gift', 'wer war das?'], checkpoint: ['luigi ist da', 'checkpoint!', 'safe', 'Luigi hält die stellung'],
  ...
  holf: ['HOLF!', 'pokal pog'], levelstart: ['endlich stream', 'hallo imp', 'hafi!', 'zu spät wie immer', 'hallo chat'], levelclear: ['GG', 'WERBEPARTNER POG', 'kanal gerettet?', 'sponsor money', 'luigi unterschreibt'],
  ...
  timeout: ['STREAM STARTET OHNE DICH', 'zu spät LUL', 'classic imp', 'unpünktlich'], boss: ['BOSS TIME', 'monkaS', 'LETS GO', 'boss musik pog'], modruf: ['BANNHAMMER', 'MOD POWER', 'luigi räumt auf', 'gebannt LUL'],
