...
def('ludwig_idle', LUD);
def('ludwig_walk', LUD.slice(0, 23).concat(['....JJJ..JJJ....', '...JJJ....JJJ...', '..JJJ......JJJ..', '.ooo........ooo.', '.ooo........ooo.']));
def('ludwig_hammer', LUD.map((r, i) => i === 10 ? '.....eeeeeeAA...' : i === 11 ? '....seeeeeeAA...' : i === 9 ? '......ssss.AA...' : i === 8 ? '.....ssssss.AA..' : i >= 4 && i <= 7 ? mergeRow(r, '.............AAA') : r));
// Sinan ------------------------------------------------------------------------
const SINAN = [
