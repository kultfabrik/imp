...
const PERKS = {
  ...
  modruf: { name: 'Mod-Ruf', desc: '[E] Luigi schwingt einmal pro Level den Bannhammer (Bildschirm-Clear).', cost: 350, icon: 'M' },
...
const JOKES = [
  ...
  'Mein Assistent heißt Luigi. Er ist der Grund, warum wir noch existieren.', 'Ich hab die Hotline angerufen. Sie hat zurückgelacht.', 'Wusstet ihr: 9 von 10 Formularen sind unnötig. Das zehnte auch.',
